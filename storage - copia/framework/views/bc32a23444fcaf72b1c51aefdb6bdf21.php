													...
													<div class="tab-single review-panel">
														<div class="row">
															<div class="col-12">
																...
																<form class="form" method="post" action="<?php echo e(route('product.review.store',$product_detail->slug)); ?>">
                                                                    <?php echo csrf_field(); ?>
                                                                    <div class="row">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Repositorios\laMediaAgua\resources\views/frontend/pages/product_detail.blade.php ENDPATH**/ ?>