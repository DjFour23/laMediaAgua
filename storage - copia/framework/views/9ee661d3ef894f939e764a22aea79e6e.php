				...
				<div class="row">
					<div class="col-lg-6 col-12">
						<div class="about-content">
							...
							<div class="button">
								<a href="<?php echo e(route('blog')); ?>" class="btn">Visita nuestro Blog</a>
								<a href="<?php echo e(route('contact')); ?>" class="btn primary">Contactanos!</a>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-12">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Repositorios\laMediaAgua\resources\views/frontend/pages/about-us.blade.php ENDPATH**/ ?>