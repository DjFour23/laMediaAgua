                                ...
                                <div class="navbar-collapse">
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="<?php echo e(Request::path()=='about-us' ? 'active' : ''); ?>"><a href="<?php echo e(route('about-us')); ?>">Acerca de nosotros</a></li>
                                            ...
                                            <li class="<?php echo e(Request::path()=='contact' ? 'active' : ''); ?>"><a href="<?php echo e(route('contact')); ?>">Contactanos!</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
...
<?php /**PATH D:\Repositorios\laMediaAgua\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>