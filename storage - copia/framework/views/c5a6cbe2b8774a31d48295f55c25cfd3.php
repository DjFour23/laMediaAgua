            ...
            <div class="order-info">
              ...
              <table class="table">
                    ...
                    <tr>
                        ...
                        <td> : <?php if($order->payment_method=='cod'): ?> Contra entrega <?php else: ?> Paypal <?php endif; ?></td>
                    </tr>
                    <tr>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Repositorios\laMediaAgua\resources\views/backend/order/show.blade.php ENDPATH**/ ?>