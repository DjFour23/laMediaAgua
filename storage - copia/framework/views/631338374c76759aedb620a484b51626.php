      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; <a href="https://github.com/DjFour23" target="_blank">DjFour23</a> <?php echo e(date('Y')); ?></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
...
<?php /**PATH D:\Repositorios\laMediaAgua\resources\views/backend/layouts/footer.blade.php ENDPATH**/ ?>