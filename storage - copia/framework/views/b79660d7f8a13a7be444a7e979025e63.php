													...
													<div class="list-content">
														<div class="product-content">
															<div class="product-price">
                                                                ...
                                                                <?php if($product->price != $after_discount): ?>
									...
									<div class="row no-gutters">
										...
										<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
											<div class="quickview-content">
                                                ...
                                                <?php if($product->price != $after_discount): ?>
                                                    <h3>$<?php echo e(number_format($after_discount, 2)); ?></h3>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Repositorios\laMediaAgua\resources\views/frontend/pages/product-lists.blade.php ENDPATH**/ ?>