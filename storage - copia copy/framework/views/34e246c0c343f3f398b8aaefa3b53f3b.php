				...
				<div class="row">
					...
					<div class="col-lg-2 col-md-6 col-12">
						...
						<div class="single-footer links">
							<h4>Information</h4>
							<ul>
								<li><a href="<?php echo e(route('about-us')); ?>">Acerca de nosotros</a></li>
								<li><a href="#">Preguntas frecuentes</a></li>
								<li><a href="#">Terminos y condiciones</a></li>
								<li><a href="<?php echo e(route('contact')); ?>">Contactanos!</a></li>
				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>Copyright © <?php echo e(date('Y')); ?> <a href="https://github.com/DjFour23" target="_blank">DjFour23</a>  -  All Rights Reserved.</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
...
<?php /**PATH D:\Repositorios\laMediaAgua\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>