    ...
    <div class="card-body">
      <form method="post" action="<?php echo e(route('product.store')); ?>">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Ingresa el titulo"  value="<?php echo e(old('title')); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input id="price" type="number" name="price" placeholder="Ingresa el precio"  value="<?php echo e(old('price')); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <input id="discount" type="number" name="discount" min="0" max="100" placeholder="Ingresa el descuento" value="<?php echo e(old('discount')); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          <label for="condition">Condicion<span class="text-danger">*</span></label>
          <select name="condition" class="form-control">
              <option value="">--Selecciona una condicion--</option>
              <option value="default">Predefinido</option>
              <option value="new">Nuevo</option>
              <option value="hot">Nuevo lanzamiento</option>
          </select>
        </div>

        <div class="form-group">
          <label for="stock">Existencias (stock) <span class="text-danger">*</span></label>
          <input id="quantity" type="number" name="stock" min="0" placeholder="Ingresa existencias "  value="<?php echo e(old('stock')); ?>" class="form-control">
    ...
    if(cat_id !=null){
      ...
      $.ajax({
        ...
        success:function(response){
          ...
          var html_option="<option value=''>----Selecciona subcategoria----</option>"
          if(response.status){
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Repositorios\laMediaAgua\resources\views/backend/product/create.blade.php ENDPATH**/ ?>