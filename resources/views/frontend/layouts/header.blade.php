            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            <li><i class="ti-location-pin"></i> <a href="{{ route('order.track') }}">Rastrea tu
                                    pedido</a></li>
                            ...
                            @else
                                <li><i class="ti-power-off"></i><a href="{{ route('login.form') }}">Iniciar sesion /</a> <a
                                        href="{{ route('register.form') }}">Registrate!</a></li>
                            @endauth
                        </ul>
                    </div>
                    <!-- End Top Right -->
                ...
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        ...
                        <a href="{{ route('home') }}"><img
                                src="@foreach ($settings as $data) {{ $data->logo }} @endforeach" width="150"
                                alt="logo"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                                    ...
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="{{ Request::path() == 'about-us' ? 'active' : '' }}"><a
                                                    href="{{ route('about-us') }}">Acerca de nosotros</a></li>
