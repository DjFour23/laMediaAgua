                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="checkout-form">
                                ...
                                @auth @else<span style="font-size:12px;" class="text-danger">[Por favor, regístrese para realizar el pago más rápidamente]</span>@endauth
                                <!-- Form -->
                                <div class="row">
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <ul>
                                            ...
                                            @if(session('coupon'))
                                            <li class="coupon_price" data-price="{{session('coupon')['value']}}">Usted ahorra <span>${{number_format(session('coupon')['value'],2)}}</span></li>
                                            @endif
                                            @php
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                <input name="payment_method"  type="radio" value="cod"> <label> Contra entrega</label><br>
                                                {{-- <input name="payment_method"  type="radio" value="paypal"> <label> PayPal</label> --}}
                                                <input name="payment_method"  type="radio" value="payu"> <label> PayU</label><br>
                                            </form-group>
