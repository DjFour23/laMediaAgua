                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        ...
                        <div class="row">
                            @if (count($products))
                                                            ...
                                                            <div class="product-action">
                                                                <a data-toggle="modal" data-target="#{{ $product->id }}"
                                                                    title="Quick View" href="#"><i
                                                                        class=" ti-eye"></i><span>Compra rapida</span></a>
                                                                <a title="Wishlist"
                                            ...
                                            <div class="col-lg-8 col-md-6 col-12">
                                                <div class="list-content">
                                                    ...
                                                    <a  href="{{ route('product-detail', $product->slug) }}" class="btn cart"
                                                        data-id="{{ $product->id }}">Detalle del producto</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @endforeach
                            @else
                                <h4 class="text-warning" style="margin:100px auto;">No hay productos en esta categoria.</h4>
                            @endif
                        </div>
                        <div class="row">
