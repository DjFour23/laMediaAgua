                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Detalle del post</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>By {{$post->author_info['name']}}</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('d M, Y')}}</a><a href="javascript:void(0);"><i class="fa fa-comments"></i>Comentarios ({{$post->allComments->count()}})</a></span>
                                    </div>
                            ...
                            <div class="col-12 mt-4">
                                <div class="reply">
                                    <div class="reply-head comment-form" id="commentFormContainer">
                                        <h2 class="reply-title">Comentanos!</h2>
                                        <!-- Comment Form -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Comentar</span><span class="comment_btn reply" style="display: none;">Contestar comentario</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-5">
                                Necesitas <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Iniciar sesion</a> O <a style="color:blue" href="{{route('register.form')}}">Registrarte</a> para comentar.
                            ...
                            <div class="col-12">
                                <div class="comments">
                                    <h3 class="comment-title">Comentatios ({{$post->allComments->count()}})</h3>
                                    <!-- Single Comment -->
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget recent-post">
                            <h3 class="title">Pot's recientes</h3>
