    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title"  placeholder="Ingresa el titulo"  value="{{$product->title}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          ...
          <input id="discount" type="number" name="discount" min="0" max="100" placeholder="Ingresa el descuento"  value="{{$product->discount}}" class="form-control">
          @error('discount')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
            <option value="">--Selecciona un estado--</option>
              <option value="default" {{(($product->condition=='default')? 'selected':'')}}>Predefinido</option>
              <option value="new" {{(($product->condition=='new')? 'selected':'')}}>Nuevo</option>
              <option value="hot" {{(($product->condition=='hot')? 'selected':'')}}>Nuevo lanzamiento</option>
          </select>
        </div>
